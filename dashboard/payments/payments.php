        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            <h3 class="box-title">New Payment Transaction</h3>
                            <!-- Button trigger modal -->
                            <label type="button" class="btn btn-primary waves-effect waves-light" data-toggle="modal" data-target="#addpaymentModal">
                            Add Payment
                            </label>
                                        ...
                                        <?php 
                                            ...
                                            $result = mysqli_query($db, $query);
                                                while($row = mysqli_fetch_array($result)){
                                                    ...
                                                    $query2 = "SELECT * FROM occupants WHERE id={$row['occupant_id']}";
                                                    $result2 = mysqli_query($db, $query2);
                                                    $row2 = mysqli_fetch_array($result2);
