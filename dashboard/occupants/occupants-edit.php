        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse slimscrollsidebar">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="occupants.php" class="waves-effect"><i class="fa fa-table fa-fw"
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Occupants</h4>
                    </div>
                ...
                <div class="row">
                    <!-- <div class="col-md-4 col-xs-12"> -->
                        <div class="white-box">
                            ...
                            <form method="post" action="occupants-validate.php" class="form-horizontal form-material">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <select class="btn btn-warning dropdown-toggle col-sm-1" name="room">
                                            ...
                                            $query4 = "SELECT * FROM occupants WHERE id=$id";
                                            ...
                                            $result4 = mysqli_query($db, $query4);
                                            $roomrow = mysqli_fetch_array($result4);

                                            echo "<option selected value='{$roomrow['room']}'>{$roomrow['room']}</option>";
                                ...
                                <a type="button" href="occupants.php" class="btn btn-primary waves-effect waves-light">Back</a>

                                <button type="submit" name="editoccupant" class=" btn btn-info waves-effect waves-light">Save changes</button>
