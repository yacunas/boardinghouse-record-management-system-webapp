        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row bg-title">
                    ...
                    <a href="../../login.php" class="btn btn-danger pull-right m-l-20 btn-rounded btn-outline hidden-xs hidden-sm waves-effect waves-light">Logout</a>
                        <ol class="breadcrumb">
                            <li><a href="../index.php">Dashboard</a></li>
                            <li class="active">Occupants Table</li>
                        </ol>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            <h3 class="box-title">Occupants Table</h3>
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <td>
                                                <a type="button" class="btn btn-info waves-effect waves-light btn-sm" href="occupants-edit.php?id=<?php echo $row['id']; ?>">
                                                Update
                                                </a>
                                                <a type="button" class="btn btn-danger waves-effect waves-light btn-sm" href="occupants-validate.php?delete=<?php echo $row['id']; ?>">
                                                Remove
                                                </a>
                                            </td>
                                        <?php }?>
