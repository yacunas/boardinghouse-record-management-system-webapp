                        ...
                        <div class="white-box">
                            <form action="rooms-validate.php" method="post">
                                ...
                                ?>
                                    ...
                                    <input name="room" type="text" class="form-control form-control-line" value="<?php echo $row['room'];?>"> 
                                    <br/>
                                ...
                                <div class="form-group">
                                    <label class="col-md-25">Room Rate</label>
                                        <input name="rate" type="text" class="form-control form-control-line" value="<?php echo $row['rate'];?>"> </input>
                                    <br/>
                                ...
                                <a type="button" href="rooms.php" class="btn btn-primary waves-effect waves-light">Back</a>

                                <button type="submit" name="editroom" class=" btn btn-info waves-effect waves-light">Save changes</button>
